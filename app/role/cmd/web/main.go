...
func initExtend() {
	...
	gin_config.InitConfig(path+"/app/role/role_config/", "go_role")
...
*/
func initTable() {
	err := gin_mysql.UseMysqlV2(nil).AutoMigrate(&role_model.Role{}, &role_model.RoleMenu{}, role_model.RoleUser{})
	if err != nil {
