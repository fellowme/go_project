...
func (receiver ProductControl) GetProductStockList(c *gin.Context) {
	var req product_param.GetProductStockRequestParam
	if err := c.ShouldBindQuery(&req); err != nil {
		zap.L().Error(" product GetProductStockList error", zap.Any("error", err))
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, gin_translator.GetErrorMessage(err), nil, c)
		return
	}
	data, err := receiver.service.GetProductStockListServiceByParam(req)
	if err != nil {
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, err.Error(), nil, c)
		return
	}
...
func (receiver ProductControl) PostProductStock(c *gin.Context) {
	var req product_param.PostProductStockRequestParam
	if err := c.ShouldBind(&req); err != nil {
		zap.L().Error(" product PostProductStock error", zap.Any("error", err))
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, gin_translator.GetErrorMessage(err), nil, c)
		return
	}
	err := receiver.service.PostProductStockServiceByParam(req)
	if err != nil {
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, err.Error(), nil, c)
		return
	}
...
func (receiver ProductControl) PatchProductStock(c *gin.Context) {
	var req product_param.PostProductStockRequestParam
	if err := c.ShouldBind(&req); err != nil {
		zap.L().Error(" product PatchProductStock error", zap.Any("error", err))
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, gin_translator.GetErrorMessage(err), nil, c)
		return
	}
	id, err := strconv.Atoi(c.Param("id"))
	...
	req.Id = id
	err = receiver.service.PatchProductStockServiceByParam(req)
	if err != nil {
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, err.Error(), nil, c)
		return
	}
...
func (receiver ProductControl) DeleteProductStock(c *gin.Context) {
	id, err := strconv.Atoi(c.Param("id"))
	if err != nil {
		zap.L().Error(" product PatchProduct error", zap.Any("error", err))
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, gin_translator.GetErrorMessage(err), nil, c)
	...
	err = receiver.service.DeleteProductStockServiceById(id)
	if err != nil {
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, err.Error(), nil, c)
		return
	}
...
func (receiver ProductControl) DeleteProductStockById(c *gin.Context) {
	var req product_param.PostProductStockByIdsRequestParam
	if err := c.ShouldBind(&req); err != nil {
		zap.L().Error(" product DeleteProductStockById error", zap.Any("error", err))
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, gin_translator.GetErrorMessage(err), nil, c)
		return
	}
	err := receiver.service.DeleteProductStockByIdServiceById(req)
	if err != nil {
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, err.Error(), nil, c)
		return
	}
...
func (receiver ProductControl) GetProductStockById(c *gin.Context) {
	var req product_param.PostProductStockByIdsRequestParam
	if err := c.ShouldBindQuery(&req); err != nil {
		zap.L().Error(" product GetProductStockById error", zap.Any("error", err))
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, gin_translator.GetErrorMessage(err), nil, c)
		return
	}
	data, err := receiver.service.GetProductStockByIdServiceById(req)
	if err != nil {
		gin_util.ReturnResponse(http.StatusOK, gin_util.FailCode, err.Error(), nil, c)
		return
	}
